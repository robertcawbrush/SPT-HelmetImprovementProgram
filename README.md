Text (not markdown) copy of the description on hub.spt. If you can get to it just read the description [HERE](https://hub.sp-tarkov.com/files/file/1636-helmet-improvement-program/)
